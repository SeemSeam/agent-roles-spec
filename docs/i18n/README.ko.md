...
- **Version**: `0.1.0`
- **수준**: `preview`
- **Purpose**: spec-compliant Agent Roles를 만들고 audit하며, 실행 가능한 compliance 및 optimization findings를 제공합니다.
- **Best for**: 새 Roles 초안 작성, Role source audit, memory/skills/prompts 개선, catalog readiness 확인.
- **Contents**: Role authoring memory, Role creation/audit skill, 재사용 가능한 audit prompt, validation notes, host adapter display metadata.
- **Adapters**: CCB, Claude Code, Codex, HIVE.

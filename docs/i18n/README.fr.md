...
- **Version** : `0.5.0`
- **Niveau** : `stable`
- **Objectif** : Examine la dérive d'architecture, les frontières, la topologie des dépendances, les décisions, l'impact des changements et les compromis de fiabilité sans dépendre d'un seul outil.
- **Idéal pour** : cycles et direction des dépendances, frontières de modules, fitness functions, dérive des ADR, rayon de migration et fiabilité des systèmes distribués.
- **Contenu** : instructions de Role, skills ciblés pour topologie, frontières, fitness, décisions, impact et fiabilité, sources de preuve optionnelles, suite d'évaluation, prompt, documentation d'outils, plugins et adaptateurs de host.
- **Adaptateurs** : CCB, Claude Code, Codex, HIVE.
- **Installer** : `agent-roles add agentroles.archi`
...
- **Version** : `0.2.2`
- **Niveau** : `preview`
- **Objectif** : Crée, recherche, formalise en blueprint, ingère et audite des Agent Roles conformes à la spec avec des gates fondés sur des preuves.
- **Idéal pour** : rédiger de nouveaux Roles, auditer le Role source, produire des research briefs, scorecards de candidats, blueprint gates, vérifier la catalog readiness, et rechercher des outils et techniques de construction de skills.
- **Recherche de skills** : utilise une recherche web publique et bornée pour les outils et techniques actuels de construction de skills, avec préférence pour les docs officielles et les exemples maintenus.
- **Contenu** : mémoire d'authoring de Roles, skills de création/audit, source-ingest, research, candidate-score et blueprint, prompts réutilisables, référence de recherche skill construction, artifact templates, preview schemas, script local d'inventaire, notes de validation et métadonnées d'affichage des host adapters.
- **Adaptateurs** : CCB, Claude Code, Codex, HIVE.
- **Installer** : `agent-roles install mother`
- **Mettre à jour** : `agent-roles update mother`

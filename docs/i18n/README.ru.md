...
- **Версия**: `0.2.0`
- **Уровень**: `preview`
- **Назначение**: Создаёт и аудирует spec-compliant Agent Roles, включая web-backed research по skill construction, когда это полезно.
- **Лучше всего для**: подготовки новых Roles, аудита Role source, улучшения memory, skills и prompts, проверки catalog readiness, а также исследования skill construction tools и techniques.
...
- **Содержимое**: Role authoring memory, skill создания и аудита Role, переиспользуемые creation/audit prompts, skill construction research reference, validation notes и host adapter display metadata.
- **Adapters**: CCB, Claude Code, Codex, HIVE.

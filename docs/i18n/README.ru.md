...
- **Версия**: `0.1.0`
- **Уровень**: `preview`
- **Назначение**: Создаёт и аудирует spec-compliant Agent Roles с практическими findings по compliance и optimization.
- **Лучше всего для**: подготовки новых Roles, аудита Role source, улучшения memory, skills и prompts, а также проверки catalog readiness.
- **Содержимое**: Role authoring memory, skill создания и аудита Role, переиспользуемый audit prompt, validation notes и host adapter display metadata.
- **Adapters**: CCB, Claude Code, Codex, HIVE.

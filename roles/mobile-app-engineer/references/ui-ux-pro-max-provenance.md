...
`agentroles.mobile_app_engineer` vendors `ui-ux-pro-max` as a role-contained
skill for mobile UI/UX design intelligence.
...
Use `skills/ui-ux-pro-max/scripts/search.py` for design-system, mobile UX,
color, typography, chart, React Native, Flutter, SwiftUI, and Jetpack Compose
recommendations when mobile interface quality is central.

Do not store generated `design-system/` output, screenshots, device logs,
project-specific URLs, signing material, or private brand assets in Role
source.

...
configuration, and role-contained plugin content.

Hot reload and global plugin installation are outside this preview role.

If a Codex adapter mounts this Role, project-specific instance naming, scope,
permissions, and prompt additions belong in the adapter's Project Binding
representation, not in the Role source.

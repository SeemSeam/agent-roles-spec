...
commands, MCP servers, and role-contained plugin content.

This preview role does not require a live Claude Code mount implementation.

If a Claude Code adapter mounts this Role, project-specific instance naming,
scope, permissions, and prompt additions belong in the adapter's Project
Binding representation, not in the Role source.
